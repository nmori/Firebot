...
module.exports = function (grunt) {
    ...
    grunt.config.merge({
        shell: {
            ...
            packdarwin: {
                command: `npx --no-install @electron/packager . Firebot --platform=darwin ${flags} --arch=x64 --arch=arm64 --extend-info="extra.plist" --extra-resource="./src/resources/firebot-setup-file-icon.icns"`
            },
            packlinux: {
