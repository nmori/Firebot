...
(function() {
    ...
    angular
        ...
        .component("eosOverlayInstance", {
            ...
            template: `
            <eos-container header="オーバーレイインスタンス" pad-top="$ctrl.padTop" ng-if="$ctrl.settings.getSetting('UseOverlayInstances')">
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="chat-effect-type">{{$ctrl.effect.overlayInstance ? $ctrl.effect.overlayInstance : 'デフォルト'}}</span> <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu chat-effect-dropdown">
                        <li ng-click="$ctrl.effect.overlayInstance = null"><a href>デフォルト</a></li>
                        ...
                        <li class="divider"></li>
                        <li ng-click="$ctrl.showEditOverlayInstancesModal()"><a href>インスタンスを編集</a></li>
                    </ul>
                </div>
            </eos-container>
       `,
