        ...
        .component("discordFileUploadList", {
            ...
            template: `
                <div>
                    <div ng-repeat="channel in $ctrl.model track by $index" style="margin-bottom: 4px;">
                        <div style="display:flex;height: 45px; align-items: center; justify-content: space-between;padding: 0 15px;background-color:#44474e;border-radius: 4px;">
                            ...
                            <div style="display: flex;align-items: center;justify-content: center;">
                                <button class="filter-bar" ng-click="$ctrl.editFile($index)" style="margin: 0; margin-right: 13px;" aria-label="ファイルを編集">編集</button>
                    ...
                    <div>
                        <button ng-if="$ctrl.model.length < 10" class="filter-bar" ng-click="$ctrl.addFile()" uib-tooltip="ファイルを追加" tooltip-append-to-body="true" aria-label="ファイルを追加">
