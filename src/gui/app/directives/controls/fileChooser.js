    ...
    angular
        ...
        .component("fileChooser", {
            ...
            <div style="display: flex;flex-direction: row;align-items: center;">
                <button class="btn btn-default" ng-click="$ctrl.openFileExporer()">{{ $ctrl.isFile ? 'ファイルを選ぶ' : 'フォルダを選ぶ' }}</button>
                <span style="padding-left: 10px;font-size: 12px;max-width: 400px;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;">{{$ctrl.model ? $ctrl.model : "ファイルは選択されていません"}}</span>
