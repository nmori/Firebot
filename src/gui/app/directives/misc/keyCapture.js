        ...
        .component("keyCapture", {
            ...
            template: `
                <div class="hotkey-capture" ng-class="{ 'capturing': $ctrl.isCapturingKey }">
                    ...
                    <span class="clickable" style="margin-left: 10px;" uib-tooltip="現在のキーをクリア" tooltip-append-to-body="true" ng-click="$ctrl.clearKey()" ng-show="!$ctrl.isCapturingKey && $ctrl.keyDisplay != null && $ctrl.keyDisplay.length > 0"><i class="far fa-times-circle"></i></span>
                </div>
            `,
