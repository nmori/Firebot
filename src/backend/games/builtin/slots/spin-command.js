...
const spinCommand = {
    definition: {
        ...
        active: true,
        trigger: "!spin",
        description: "繧ｹ繝ｭ繝・ヨ繧ｲ繝ｼ繝繧帝幕蟋九＠縺ｾ縺・,
    ...
    onTriggerEvent: async event => {
        ...
        try {
            ...
            logger.error(error);
            await twitchChat.sendChatMessage(`${user.displayName}縺輔ｓ, 雉・≡蜃ｦ逅・↓繧ｨ繝ｩ繝ｼ縺檎匱逕溘＠縺溘◆繧√く繝｣繝ｳ繧ｻ繝ｫ縺輔ｌ縺ｾ縺励◆.`, null, chatter);
