...
triggers[EffectTrigger.EVENT] = ["twitch:chat-message", "firebot:highlight-message", "twitch:announcement", "twitch:viewer-arrived"];

const model = {
    definition: {
        handle: "chatMessage",
        description: "関連するコマンドまたはイベントのチャットメッセージを出力します。",
        triggers: triggers,
