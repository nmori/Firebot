...
const model = {
    definition: {
        ...
        description: "配信者のチャンネルの全ビッツのリーダーボードを、指定されたカウントまでの JSON 配列で返す。配列の各オブジェクトは `username` と `amount` を持つ。",
        examples: [
            {
                usage: "bitsLeaderboard[count, period]",
                description: "指定された期間中の、指定された回数までの配信者チャンネルのビッツのリーダーボードの JSON 配列を返す。配列の各オブジェクトは `username` と `amount` を持つ。期間には 'day'、'week'、'month'、'year' あるいは 'all' を指定できる。."
            },
            {
